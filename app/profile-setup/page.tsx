...
export default async function ProfileSetupPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-6">
      <div className="animate-fade-up w-full max-w-5xl rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6 md:p-10">
        <div className="grid gap-8 lg:grid-cols-[1.2fr_1fr] lg:items-center">
          <section>
            <CompanyLogo className="mb-6" />
            <h1 className="mt-4 text-2xl sm:text-4xl font-bold tracking-tight text-slate-900">Profil einrichten</h1>
