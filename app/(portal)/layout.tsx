...
export default async function PortalLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="bg-slate-900 text-slate-50 py-1.5 px-4 text-xs font-medium tracking-widest text-center uppercase">
        © YOT FLEET V0.5 - YOT SOLUTIONS - Work in Progress
      </div>
